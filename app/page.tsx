    ...
    >
      ...
      <div className="relative space-y-6">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-bold px-3 py-1.5 rounded-full uppercase tracking-[0.18em] bg-slate-900 text-white dark:bg-white dark:text-slate-900 shadow-md drop-shadow-sm">
            ShareHouse
          </span>
        </div>
